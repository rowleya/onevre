...
public class ConnectionManager {
	...
	private HashMap<VenueState, Vector<ConnectionDescription>> connections = new HashMap<VenueState, Vector<ConnectionDescription>>();
	private HashMap<VenueState, Vector<StreamDescription>> streams = new HashMap<VenueState, Vector<StreamDescription>>();
