...
public interface File extends Comparable<File> {
    ...
    Writer getWriter(boolean append) throws IOException;
     ...
     * @throws IOException if an error occurred accessing the underlying file server
     */
    File[] list(String pattern) throws IOException;
     ...
     * @throws IOException if an error occurred accessing the underlying file server
     */
    void move(String path) throws IOException;
}
