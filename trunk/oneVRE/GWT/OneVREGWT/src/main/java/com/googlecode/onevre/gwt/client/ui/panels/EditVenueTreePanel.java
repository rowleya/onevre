...
public class EditVenueTreePanel extends ModalPopup<DockPanel> implements ClickHandler, OpenHandler<TreeItem> , VenueTreePanel{

	Tree venueTree = new Tree();

	VenueTreeItem currentItem = null;

	PushButton ok = new PushButton("OK",this);

	ClientProfile clientProfile = null;

	GetConnections getConnections = null;
