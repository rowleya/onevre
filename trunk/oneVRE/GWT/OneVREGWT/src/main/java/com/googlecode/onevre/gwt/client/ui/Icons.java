...
public class Icons {
    ...
    public static String locationIcon = GWT.getModuleBaseURL() + "images/icons/location.png";
    public static String homeIcon = GWT.getModuleBaseURL() + "images/icons/home.png";
    public static String hostIcon = GWT.getModuleBaseURL() + "images/host.png";

    public static String fileIcon = GWT.getModuleBaseURL() + "images/defaultData.png";
    ...
    public static String deleteIcon = GWT.getModuleBaseURL() + "images/icons/close.png";
