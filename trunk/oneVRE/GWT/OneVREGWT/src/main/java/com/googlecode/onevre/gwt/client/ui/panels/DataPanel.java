...
public class DataPanel extends FlexTable implements ClickHandler {
    ...
    private Vector<DataDescription> dataDescriptions = new Vector<DataDescription>();

    private VenueState venueState = null;

    private NamedFrame targetFrame = new NamedFrame("victim");

    private HashMap<Widget, DataDescription> dataEntrys =  new HashMap<Widget, DataDescription>();
    private HashMap<String, Widget> widgetEntrys =  new HashMap<String, Widget>();
    private HashMap<String, FlexTable> folders = new HashMap<String, FlexTable>();
...
//            this.setText(i+1,2,"");
            ...
            */
            ...
            if (data.getObjectType().equals(DataDescription.TYPE_DIR)) {
                ...
                iconPanel.add(new CreateFolderButton(venueState, data.getId(),
                        data.getHierarchyLevel() + 1).getButton());
